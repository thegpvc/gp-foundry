...
- Favour lessons that change future behaviour: a Critic ask Builders keep missing; a class of change that
...
- Fold each durable lesson into the most relevant `.github/agents/memory/topics/<topic>.md`: concise,
  actionable guidance a Builder/Critic/Fixer reads BEFORE their next task, **citing the evidence**
